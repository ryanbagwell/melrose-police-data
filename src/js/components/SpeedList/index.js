...
const SEGMENTS = [
  {
    ...
    description: 'From Woodcrest Drive to Lincoln Street',
    origin: 'Upham St. & Woodcrest Drive, Melrose, MA',
    destination: 'Upham St. & Lincoln St, Melrose, MA',
    speed: 0,
    status: 'ok',
  ...
  },
  {
    ...
    description: 'Lincoln to Woodcrest',
    origin: 'Upham St. & Lincoln St, Melrose, MA',
    destination: 'Upham St. & Woodcrest Drive, Melrose, MA',
    speed: 0,
    status: 'ok',
    trend: 'holding steady',
  },
